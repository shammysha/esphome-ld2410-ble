...
и открывают полный набор сущностей. `disabled: true` полностью убирает инстанс (без
компонента и без сущностей), а не просто скрывает его. [`ld2410-ble-component-test.yaml`](ld2410-ble-component-test.yaml) /
